...
const deleteDoctor = async (req, res) => {
    try {
        ...
        if (appointments && appointments.length > 0) {
            // Update all related appointments as cancelled
            await appointmentModel.updateMany(
                { doctor: doctorId }, 
                { cancelled: true, cancelReason: "Doctor removed from platform" }
            );
        ...
        res.json({ 
            ...
            appointmentsCancelled: appointments ? appointments.length : 0
        });
